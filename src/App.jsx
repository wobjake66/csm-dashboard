...
const CSV_CHURN_ALERTS = "https://docs.google.com/spreadsheets/d/e/2PACX-1vRiYN66PuGwyOhd2jC1gHVv5Zv1ub5vxTZU8uCQ5k1OXNbYL8NFHdonbmb7zzHpWkAooXv9P8LoCufo/pub?gid=CHURN_ALERTS_GID&single=true&output=csv"; // ← replace CHURN_ALERTS_GID after publishing churn alerts tab
      ...
      {recentAlerts.length>0&&<div style={{background:"rgba(220,38,38,.05)",border:"1px solid rgba(220,38,38,.25)",borderRadius:12,padding:16,marginBottom:16}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8}}>
          {recentAlerts.map((a,i)=>{
            ...
            return <div key={i} style={{background:"#fff",border:"0.5px solid rgba(220,38,38,.2)",borderLeft:"3px solid "+col,borderRadius:8,padding:"8px 12px"}}>
