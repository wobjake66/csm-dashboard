            ...
            <tbody>
              {[...inc.map(r=>({...r,_t:"increase"})),...dec.map(r=>({...r,_t:"decrease"}))].sort((a,b)=>b.n-a.n).map((r,i)=>{
                ...
                return <tr key={i}>
                  ...
                  <td style={{...tdS2,maxWidth:140,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{r.a||"—"}</td>
            ...
            <tbody>
              {[...inc.map(r=>({...r,_t:"increase"})),...dec.map(r=>({...r,_t:"decrease"}))].sort((a,b)=>b.n-a.n).map((r,i)=>{
                ...
                return <tr key={i}>
                  ...
                  <td style={{...tdS,maxWidth:140,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{r.a||"—"}</td>
                  <td style={tdS}>{r.l}</td>
